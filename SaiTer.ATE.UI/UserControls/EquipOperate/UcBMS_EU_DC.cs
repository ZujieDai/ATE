...
namespace SaiTer.ATE.UI.UserControls.EquipOperate
{
    ...
    /// 欧标导引参数读取和设置
    /// </summary>
    public partial class UcBMS_EU_DC : UcEquipOperateBase
    {
        #region 参数读取/设置
        /////////////////////充电参数1读取////////////////////////
        //0   1   PLC状态
        ...
        private void UcBMS_EU_DC_Load(object sender, EventArgs e)
        {
            GetChargerID();
            LoadParm();
        }
        ...
        {
            EquipMentControl.BMS.BMS_ON(lstChargerID, new string[] { "emtBMS_EU_DC" });
        }

        private void btnStop_Click(object sender, EventArgs e)
        {
            EquipMentControl.BMS.BMS_OFF(lstChargerID, new string[] { "emtBMS_EU_DC" });
        }
        ...
        private void RefreshDgv(UIDataGridView dgv, string[] names, bool isRead, byte tComm)
        {
            try
            {
                var dic = EquipMentControl.BMS.BMSGetParameter_EU_DC(lstChargerID, tComm, new string[] { "emtBMS_EU_DC" });
        ...
        private void btnSet1_Click(object sender, EventArgs e)
        {
            if (dgvParamSet1.Rows.Count == 15)
            {
                ...
                EquipMentControl.BMS.BMSSetPara1_EU_DC(lstChargerID, para, RESS_SoC, MaxCurrent, MaxVoltage, new string[] { "emtBMS_EU_DC" });
            }
        }
        ...
        private void btnSet2_Click(object sender, EventArgs e)
        {
            if(dgvParamSet2.Rows.Count == 5)
            {
                ...
                EquipMentControl.BMS.BMSSetPara2_EU_DC(lstChargerID, FullSOC, BulkSOC, TargetVolt, TargetCurrent, ReadyVolt, new string[] { "emtBMS_EU_DC" });
            }
        }
        ...
        private void btnSet3_Click(object sender, EventArgs e)
        {
            if (dgvParamSet3.Rows.Count == 2)
            {
                ...
                EquipMentControl.BMS.BMSSetPara3_EU_DC(lstChargerID, FullSOCRemainTime, BulkSOCRemainTime, new string[] { "emtBMS_EU_DC" });
            }
        }
    }
}
