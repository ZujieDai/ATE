...
namespace SaiTer.ATE.UI.Assitand.PrjUI.ExtentClass
{
    ...
    /// </param>
    public delegate void DataGridViewCheckBoxRowHeaderEventHander(object sender,
                    DataGridViewCheckBoxRowHeaderEventArgs e);
    #endregion
    ...
    /// </summary>
    public class DataGridViewCheckBoxRowHeaderEventArgs : EventArgs
    {
    ...
    #region === DataGridViewRowHeaderCell with a check box===
    /// <summary>
    /// Displays a check box user interface (UI) to use in a System.Windows.Forms.DataGridView control. 
    /// </summary>
    public class DataGridViewCheckBoxRowHeaderCell : DataGridViewRowHeaderCell
    {
        #region ---Field region---
        ...
        private static bool b_Checked = false;
        ...
        /// </summary>
        public event DataGridViewCheckBoxRowHeaderEventHander OnCheckBoxClicked;
        #endregion
        ...
        protected override void OnMouseClick(DataGridViewCellMouseEventArgs e)
        {
            ...
            && p.Y >= checkBoxLocation.Y && p.Y <= checkBoxLocation.Y + checkBoxSize.Height)
            {
                _checked = !_checked;
                //获取行头checkbox的选择状态
                DataGridViewCheckBoxRowHeaderEventArgs ex =
                    new DataGridViewCheckBoxRowHeaderEventArgs();
                ex.Checked = _checked;
