...
namespace SaiTer.ATE.Business
{
    ...
    /// 待机功耗流程
    /// </summary>
    public class QB_RT_DC_StandbyPowerConsumption : BusinessBase
    {
        public QB_RT_DC_StandbyPowerConsumption(int trialType) { TrialType = trialType; }
    ...
    /// 待机功耗流程
    /// </summary>
    public class QB_RT_DC_StandbyPowerConsumption_Old : BusinessBase
    {
        public QB_RT_DC_StandbyPowerConsumption_Old(int trialType) { TrialType = trialType; }
        private double PowerConsumptionMax;
        public override void InitializeParams()
        {
            Init();
