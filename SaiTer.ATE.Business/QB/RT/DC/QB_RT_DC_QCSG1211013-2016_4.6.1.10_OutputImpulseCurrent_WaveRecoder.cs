...
{
    /// <summary>
    ///输出冲击电流  直流测试(录波板)   //GB_RT_DC_NBT33008.1-2018_5.15.7_OutputImpulseCurrent_WaveRecoder
    /// </summary>
    public class QB_RT_DC_OutputImpulseCurrent_WaveRecoder : BusinessBase
    {
        public QB_RT_DC_OutputImpulseCurrent_WaveRecoder(int trialType) { TrialType = trialType; }
