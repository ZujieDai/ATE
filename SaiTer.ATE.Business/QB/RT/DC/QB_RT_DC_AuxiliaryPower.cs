...
{
    public class QB_RT_DC_AuxiliaryPower : BusinessBase
    {
        /// <summary>
        /// 企标研测直流：待机功耗试验
        /// </summary>
        public QB_RT_DC_AuxiliaryPower(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    //设置测试条件
                    SetConditionValues();
                    string sTmpName = "低压辅助电源";
                    string info = "【" + sTmpName + "】为人工检查。请确认是否合格\r\n注：勾选上为合格";
