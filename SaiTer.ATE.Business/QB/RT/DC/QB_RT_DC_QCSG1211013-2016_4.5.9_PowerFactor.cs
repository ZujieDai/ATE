...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标直流  功率因数试验(恒功率)
    /// </summary>
    public class QB_RT_DC_PowerFactor : BusinessBase
    {
        int trlTimeOut_S = 30;
        ...
        public QB_RT_DC_PowerFactor(int type)
        {
            TrialType = type;
        }
    ...
    /// 企标研测直流：功率因数试验
    /// </summary>
    public class QB_RT_DC_PowerFactor_Old : BusinessBase
    {
        int trlTimeOut_S = 30;
        double RealPower = 0;
        double Rate = 0;
        ...
        public QB_RT_DC_PowerFactor_Old(int type)
        {
            TrialType = type;
        }
