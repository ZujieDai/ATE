...
namespace SaiTer.ATE.Business
{
    ...
    /// 企标研测直流：急停功能试验
    /// </summary>
    public class QB_RT_DC_EmergencyStopFunction : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public QB_RT_DC_EmergencyStopFunction(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    ControlEquipMent.Oscillograph?.Oscillograph_CursorsSet("X");
                    ControlEquipMent.Oscillograph?.Oscillograph_CursorPosition_X_Single(6, false, 0, 0, true);
                    ...
                    ProcessDataTmp(dTime, TrialItem.ItemName, "直流输出接触器断开时间(ms)", "0", "100", dImgs);
                    ...
                    time = GetTriggerTime_Single(4, false, 0, 60, 1, false, false, 0.05);//0到100ms
                    ...
                    ProcessDataTmp(dTime, TrialItem.ItemName, "急停后输出电压下降时间(ms)", "0", "1000", dImgs);
