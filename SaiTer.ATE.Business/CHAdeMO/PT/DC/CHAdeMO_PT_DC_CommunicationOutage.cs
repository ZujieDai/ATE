...
namespace SaiTer.ATE.Business
{
    ...
    /// 通讯中断
    /// </summary>
    public class CHAdeMO_PT_DC_CommunicationOutage : BusinessBase
    {
        public CHAdeMO_PT_DC_CommunicationOutage(int type)
        {
            TrialType = type;
        }
        ...
        public override void ExecuteMethod()
        {
            ...
            finally
            {
                ...
                //恢复CAN正常
                SendNoticeToUIAndTxtFile("恢复通信正常...");
                byte[] DCBMSBitS = new byte[4];
                DCBMSBitS[2] = 1;
                DCBMSBitS[3] = 1;
                ControlEquipMent.BMS.BMSSetKState_DC(testWorkParam.lstIDs, 0x87, DCBMSBitS, new string[] { "emtBMS_JP_DC" });
                Thread.Sleep(300);
            }
        }
        ...
        private void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    //模拟通信中断
                    SendNoticeToUIAndTxtFile("模拟通信中断...");
                    byte[] DCBMSBitS = new byte[4];
                    DCBMSBitS[2] = 0;
                    DCBMSBitS[3] = 0;
                    ControlEquipMent.BMS.BMSSetKState_DC(testWorkParam.lstIDs, 0x87, DCBMSBitS, new string[] { "emtBMS_JP_DC" });
                    ...
                    ProcessDataResult(testWorkParam.lstIDs, stmp, "是否结束充电", stmp == "是" ? true : false, "通讯中断测试");
                    ...
                    ProcessDataTmp(d1, "通讯中断测试", "输出电压(V)", "-", "20");
                    ...
                    ProcessDataTmp(d1, "通讯中断测试", "输出电流(A)", "-", "5");
