...
namespace SaiTer.ATE.Business
{
    ...
    /// 其他充电故障
    /// </summary>
    public class CHAdeMO_PT_DC_OtherChargingFaults : BusinessBase
    {
        public CHAdeMO_PT_DC_OtherChargingFaults(int type)
        {
            TrialType = type;
        }
        ...
        private void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    //提示手动模拟故障
                    SendNoticeToUIAndTxtFile("请手动模拟充电桩故障..."); 
                    ...
                    ProcessDataResult(testWorkParam.lstIDs, stmp, "是否结束充电", stmp == "是" ? true : false, "其他充电故障测试");
                    ...
                    ProcessDataTmp(d1, "其他充电故障测试", "输出电压(V)", "-", "20");
                    ...
                    ProcessDataTmp(d1, "其他充电故障测试", "输出电流(A)", "-", "5");
