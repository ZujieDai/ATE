...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标产测直流：接触器粘连试验
    /// </summary>
    public class GB_PT_DC_ContactorAdhesion : BusinessBase
    {
        float trlTimeOut_S = 100;//超时时间
        public GB_PT_DC_ContactorAdhesion(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                info = "请人工检查充电机应停止绝缘检测过程!(枪号勾选上为PASS，否则为FAIL)";
                SendNoticeToUIAndTxtFile(info);
