...
namespace SaiTer.ATE.Business
{
    ...
    /// 输入欠压保护
    /// </summary>
    public class GB_PT_DC_InputUnderVoltProtection : BusinessBase
    {
        ...
        double VoltageRate = 0.85;//电压倍率  输入电压最高不能超过额定电压的倍数
        public GB_PT_DC_InputUnderVoltProtection(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                if (testWorkParam.lstIDs.Count > 0)
                {
                    ...
                    ProcessDataTmp(d1, "输入电压欠压", "欠压输入电压(V)", "-", "-");
                    ProcessDataTmp(Data_Tmp, "输入电压欠压", "欠压后输出电压(V)", "0", "30");

                    CountDownTimeInfo("请检查充电桩是否有故障报警!\r\n注：勾选上为有故障报警", 999, 2);
                    ProcessDataConnect("输入电压欠压", "是否有告警提示");
                    ...
                    ProcessDataTmp(d1, "输入电压欠压", "欠压比例(%)", "-", "85");
