...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标产测直流：限流特性试验
    /// </summary>
    public class GB_PT_DC_LimitingCurrentCharacter : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public GB_PT_DC_LimitingCurrentCharacter(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    { DemandVoltage, DemandVoltage - 80, DemandVoltage - 270, DemandVoltage - 60, DemandVoltage};
                    List<double> Currents = new List<double>()
                    { DemandCurrent - 20, DemandCurrent + 10, DemandCurrent + 10, DemandCurrent + 10, DemandCurrent - 15 };
