...
{
    /// <summary>
    /// 国标产测直流：连接检测信号断开试验(录波板)
    /// </summary>
    public class GB_PT_DC_CC1DisConnection_WaveRecoder : BusinessBase
    {
...
        Dictionary<int, double[]> OscTime_Tmp = new Dictionary<int, double[]>();//示波器光标卡点时间
        ...
        public GB_PT_DC_CC1DisConnection_WaveRecoder(int trialType) { TrialType = trialType; }
