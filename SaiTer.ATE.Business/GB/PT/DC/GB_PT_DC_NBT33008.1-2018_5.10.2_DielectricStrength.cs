...
namespace SaiTer.ATE.Business
{
    ...
    /// </summary>
    public class GB_PT_DC_DielectricStrength : BusinessBase
    {
        string sState;
        string FlowItemName;
        ...
        string info = "";
        string InputSwitch = "";
        public GB_PT_DC_DielectricStrength(int trialType)
        {
            TrialType = trialType;
        }
        /// <summary>
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                if (testWorkParam.lstIDs.Count > 0)
                {
                    ...
                    //恢复开关状态
                    list = new List<bool>() { true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false };
                    ControlEquipMent.ControlBoard.ControlResistanceSetRelay(list);
                    Thread.Sleep(300);
                    #endregion
                }
        ...
        public override void ProcessData()
        {
            ...
            try
            {
                ...
                {
                    string data = sState + "|" + FlowItemName + "|" + LOSETCurrent + "|" + HISETCurrent + "|null";
                    StResultData Result = ResultData.Dequeue();
                    ...
                    else
                    {
                        ...
                        {
                            data = sState + "|" + FlowItemName + "|" + LOSETCurrent + "|" + HISETCurrent + "|" + ReturnStrS[3];
