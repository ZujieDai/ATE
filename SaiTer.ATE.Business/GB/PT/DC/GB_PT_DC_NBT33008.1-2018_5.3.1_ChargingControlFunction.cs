...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标产测直流：充电控制功能
    /// </summary>
    public class GB_PT_DC_ChargingControlFunction : BusinessBase
    {
        int trlTimeOut_S = 30;

        double BMSDemandVolt = 0;
        double ResiLoadCurrent = 0;
        public GB_PT_DC_ChargingControlFunction(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    ProcessDataTmp(dic, "能量传输阶段", "充电电流(A)", (ResiLoadCurrent * 0.9).ToString("F2"), (ResiLoadCurrent * 1.1).ToString("F2"));
                    ...
                    ProcessDataTmp(dic, "能量传输阶段", "充电电压(V)", (BMSDemandVolt - 20).ToString("F2"), (BMSDemandVolt + 20).ToString("F2"));
                    ...
                    ProcessDataTmp(dic, "调整充电输出", "充电电流(A)", "18.00", "22.00");
