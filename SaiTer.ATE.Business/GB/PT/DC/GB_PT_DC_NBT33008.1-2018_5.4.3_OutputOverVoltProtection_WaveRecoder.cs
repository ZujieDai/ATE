...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标产测直流：输出过压保护试验
    /// </summary>
    public class GB_PT_DC_OutputOverVoltProtection_WaveRecoder : BusinessBase
    {
        ...
        public GB_PT_DC_OutputOverVoltProtection_WaveRecoder(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                if ((ControlEquipMent.FeedbackLoad != null || ControlEquipMent.LoopFeedbackLoad != null) && OutputVoltage <= FBLoadMaxVoltage)
                {
                    ...
                    WaitDCVoltage(testWorkParam.lstIDs, OutputVoltage);
                    Thread.Sleep(5000);
