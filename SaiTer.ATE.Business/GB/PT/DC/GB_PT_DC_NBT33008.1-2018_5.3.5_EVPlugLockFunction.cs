...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标产测直流：车辆插头锁止功能试验
    /// </summary>
    public class GB_PT_DC_EVPlugLockFunction : BusinessBase
    {
        string ItemFlow = "";
        double BMSDemandVolt = 0;
        double ResiLoadCurrent = 0;
        float trlTimeOut_S = 100;//超时时间
        public GB_PT_DC_EVPlugLockFunction(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                ProcessDataResults(testWorkParam.lstIDs, d1, "是否具备", dicResult, ItemFlow);
            }
