...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标产测直流：输出电流设定误差
    /// </summary>
    public class GB_PT_DC_OutputCurrentSetError : BusinessBase
    {
        int trlTimeOut_S = 30;
        double Error1 = 0.3;
        double Error2 = 1;
        double BMSDemandVolt = 0;
        public GB_PT_DC_OutputCurrentSetError(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                ProcessDataResult(testWorkParam.lstIDs, "-", $"{BMSDemandVolt}", true, $"设定输出电压点(V) —— Umen");
