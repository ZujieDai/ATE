...
{
    /// <summary>
    /// 电压纹波因数试验（示波器，源自南网企标，目前河南产测使用）
    /// </summary>
    public class GB_PT_DC_RippleFactor_Oscilloscope_XJ_QB : BusinessBase
    {
        int trlTimeOut_S = 30;
        ...
        double 判定准则 = 1;
        double 判定准则RMS = 0.5;
        public GB_PT_DC_RippleFactor_Oscilloscope_XJ_QB(int type)
        {
            TrialType = type;
        }
