...
{
    /// <summary>
    /// 控制导引电压限值测试   //GB_RT_DC_GBT34657.1-2017_6.3.6.1_ControlBMSVoltageLimit_WaveRecoder
    /// </summary>
    public class GB_RT_DC_ControlBMSVoltageLimit_WaveRecoder : BusinessBase
    {
        string ItemStatus;
        string ItemFlow;
        int trlTimeOut_S = 30;
        ...
        public GB_RT_DC_ControlBMSVoltageLimit_WaveRecoder(int type)
        {
            TrialType = type;
        }
