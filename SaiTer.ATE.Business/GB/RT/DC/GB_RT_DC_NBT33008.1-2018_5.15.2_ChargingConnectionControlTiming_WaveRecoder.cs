...
namespace SaiTer.ATE.Business
{
    ...
    /// 充电连接控制时序(录波板)
    /// </summary>
    public class GB_RT_DC_ChargingConnectionControlTiming_WaveRecoder : BusinessBase
    {
        public GB_RT_DC_ChargingConnectionControlTiming_WaveRecoder(int trialType) { TrialType = trialType; }
