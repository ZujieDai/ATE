...
namespace SaiTer.ATE.Business
{
    ...
    /// 研发测试:连接确认测试(不使用录波仪)
    /// </summary>
    public class GB_RT_DC_2025_ConnectionConfirm : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public GB_RT_DC_2025_ConnectionConfirm(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    Ks[22] = false;
                    Ks[23] = false;
                    ControlEquipMent.BMS.BMSSetKState_DC(lstIDs, 1000, 30, Ks.ToArray());
                    Thread.Sleep(1000);
                    ...
                    ////读取通道数据
                    //ControlEquipMent.WaveRecoderCtrl?.WaveRecoder_ReadChannelData(testWorkParam.lstIDs, 4, ref CC1Wave);
                    ////停止采集
                    ...
                    ProcessDataTmp(dCC1Value1, "状态0 空闲未插枪，断线模拟", "CC1(V)", "5.2", "6.8");
                    ...
                    ProcessDataTmp(dCC2Value1, "状态0 空闲未插枪，断线模拟", "CC2(V)", "11.2", "12.8");
                    ...
                    ProcessDataTmp(dCC1Value2, "状态1 未插枪，并按下枪锁", "CC1(V)", "11.2", "12.8");
                    ...
                    ProcessDataTmp(dCC2Value2, "状态1 未插枪，并按下枪锁", "CC2(V)", "11.2", "12.8");
                    ...
                    ProcessDataTmp(dCC1Value3, "状态2 以插枪，并按下枪锁", "CC1(V)", "5.2", "6.8");
                    ...
                    ProcessDataTmp(dCC2Value3, "状态2 以插枪，并按下枪锁", "CC2(V)", "5.2", "6.8");
                    ...
                    ProcessDataTmp(dCC1Value4, "状态3 已插枪，并松开枪锁", "CC1(V)", "3.65", "4.37");
                    ...
                    ProcessDataTmp(dCC2Value4, "状态3 已插枪，并松开枪锁", "CC2(V)", "5.2", "6.8");
