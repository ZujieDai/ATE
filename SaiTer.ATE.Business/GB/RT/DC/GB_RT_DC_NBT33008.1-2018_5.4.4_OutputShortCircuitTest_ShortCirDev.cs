...
namespace SaiTer.ATE.Business
{
    ...
    /// 输出短路保护(短路测试仪)
    /// </summary>
    public class GB_RT_DC__OutputShortCircuitTest_ShortCirDev : BusinessBase
    {
        int trlTimeOut_S = 30;
        ...
        public GB_RT_DC__OutputShortCircuitTest_ShortCirDev(int type)
        {
            TrialType = type;
        }
        ...
        public override void ExecuteMethod()
        {
            ...
            {
                CountDownTimeInfo("请把短路测试仪恢复正常状态!!!", 999, 0);
                //保存试验结果               
                SaveTrialResult();
