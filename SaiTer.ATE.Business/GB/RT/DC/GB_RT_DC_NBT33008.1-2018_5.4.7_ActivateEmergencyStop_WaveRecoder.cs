...
{
    /// <summary>
    /// 国标研测直流：启动急停装置试验(新录波板)
    /// </summary>
    public class GB_RT_DC_ActivateEmergencyStop_WaveRecoder : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public GB_RT_DC_ActivateEmergencyStop_WaveRecoder(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    DataAnalysis_WaveRecoder.GetDCSingleTime(CH_EStop, false, 5, ref Time_CurrentStop);
