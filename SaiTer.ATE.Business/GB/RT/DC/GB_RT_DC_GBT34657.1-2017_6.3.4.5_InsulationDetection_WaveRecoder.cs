...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标直流    绝缘检测功能试验
    /// </summary>
    public class GB_RT_DC_InsulationDetection_WaveRecoder : BusinessBase
    {
        int trlTimeOut_S = 30;
        ...
        int DzbVersion = 1;//dzb=1是600K的版本
        public GB_RT_DC_InsulationDetection_WaveRecoder(int type)
        {
            TrialType = type;
        }
