...
{
    /// <summary>
    /// 国标研测直流：保护接地连续性试验(录波板)
    /// </summary>
    public class GB_RT_DC_ProtectiveGroundingContinuance_WaveRecoder : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public GB_RT_DC_ProtectiveGroundingContinuance_WaveRecoder(int type)
        {
            TrialType = type;
        }
