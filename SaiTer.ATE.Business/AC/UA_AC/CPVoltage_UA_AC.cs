...
namespace SaiTer.ATE.Business
{
    ...
    /// 美标交流：CP电压测试
    /// </summary>
    public class CPVoltage_UA_AC : BusinessBase
    {
...
        Dictionary<int, double[]> OscTime_Tmp = new Dictionary<int, double[]>();//示波器光标卡点时间
        ...
        public CPVoltage_UA_AC(int trialType) { TrialType = trialType; }
...
                if (testWorkParam.lstIDs.Count <= 0)
                ...
                try
                {
                    ...
                    Thread.Sleep(waitTime);
                    ControlEquipMent.Oscilloscope.Oscilloscope_Trigger(testWorkParam.lstIDs, 0, "FALL", "DC", "EDGE", "10", 3, "0", "Auto");//设置3通道触发，否则采样截图会有残影
                    Thread.Sleep(waitTime);
