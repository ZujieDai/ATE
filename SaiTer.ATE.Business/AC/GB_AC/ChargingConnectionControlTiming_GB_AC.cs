...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标交流：充电连接控制时序
    /// </summary>
    public class ChargingConnectionControlTiming_GB_AC : BusinessBase
    {
        Dictionary<int, string> Data_Tmp = new Dictionary<int, string>();//临时测试数据
        Dictionary<int, double[]> OscTime_Tmp = new Dictionary<int, double[]>();//示波器光标卡点时间

        public ChargingConnectionControlTiming_GB_AC(int trialType) { TrialType = trialType; }
...
                if (testWorkParam.lstIDs.Count <= 0)
                ...
                try
                {
                    ...
                    ProcessDataTmp(Data_Tmp, "状态2", "CP电压(V)", "8.36", "9.59");
                    ...
                    ProcessDataTmp(Data_Tmp, "状态2’", "CP正电压(V)", "8.36", "9.59");
