...
namespace SaiTer.ATE.Business
{
    ...
    /// CC断线测试_国标交流
    /// </summary>
    public class CCDisConnection_GB_AC : BusinessBase
    {
...
        Dictionary<int, double[]> OscTime_Tmp = new Dictionary<int, double[]>();//示波器光标卡点时间
        ...
        public CCDisConnection_GB_AC(int trialType) { TrialType = trialType; }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                if (testWorkParam.lstIDs.Count > 0)
                {
                    ...
                    //硬件在CC断线后3秒内没有断开S2开关，需要控制（根据GB/T 34657.2-2017 6.3.4.2)
                    ...
                    ProcessDataTmp(dd, "CC断线", "K1K2断开时间(ms)", "0", maxValue, dImgs);
                    ...
                    ProcessDataTmp(Data_Tmp, "CC断线", "断线后输出电压(V)", "0", "20");
                }
            }
        }
