...
namespace SaiTer.ATE.Business
{
    ...
    /// 枪头RC电阻测试
    /// </summary>
    public class RcResistance_GB_AC : BusinessBase
    {
        ...
        public RcResistance_GB_AC(int type)
        {
            TrialType = type;
        }
        public override void InitializeParams()
        {
            ...
            //数据库参数格式
            //误差(%)=8|机械锁解锁电阻值(Ω)=680|机械锁锁止电阻值(Ω)=3500
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                ProcessDataTmp(dic, "枪头RC电阻", "松开机械锁", MinCloseResistance.ToString(), MaxCloseResistance.ToString());//锁止状态
