...
{
    public class CCS1_RT_AC_S2ControlTesting : BusinessBase
    {
...
        Dictionary<int, double[]> OscTime_Tmp = new Dictionary<int, double[]>();//示波器光标卡点时间
        ...
        public CCS1_RT_AC_S2ControlTesting(int trialType) { TrialType = trialType; }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                if (testWorkParam.lstIDs.Count > 0)
                {
                    ...
                    ProcessDataTmp(Data_Tmp, "S2断开", "CP占空比(%)", "9.5", "96.5");
                    ...
                    ProcessDataTmp(Data_Tmp, "S2闭合", "CP占空比(%)", "9.5", "96.5");
                }
            }
        }
