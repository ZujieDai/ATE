...
namespace SaiTer.ATE.Business
{
    class JP_DC_Soft
    {
        ...
        private static string APlusAddress = "DebugCADC\\ST-9980CA-DC.exe";
        private static string APlusName = "ST-9980CA-DC";//程序进程名称
        ...
        {
            //APlusClient.SendRecieve("SLAVECONNECT,OFF", "", "", 1000);
