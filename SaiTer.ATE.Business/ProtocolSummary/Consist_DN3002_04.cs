...
{
    public class Consist_DN3002_04 : ConsistSummaryBase
    {
        public Consist_DN3002_04(BusinessBase business) : base(business)
        {
        }
        ...
        public override void CacleConsistRslt(Dictionary<int, List<CanMsgRich>> dic)
        {
            ...
            foreach (int chargerId in dic.Keys)
            {
                ...
                MeasureFirstToFirstWithoutSec(dicSPN2830[chargerId], dicCEM[chargerId], 1000, out bool isQualified2, out string _ResultText2);
