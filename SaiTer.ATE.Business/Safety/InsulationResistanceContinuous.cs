...
{
    public class InsulationResistanceContinuous : BusinessBase
    {
        string FlowItemName = "";
        ...
        public InsulationResistanceContinuous(int trialType)
        {
            TrialType = trialType;
        }
        /// <summary>
            ...
            try
            {
                while (ResultData.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            data = TrialItem.ItemName + "|" + FlowItemName + "|" + LOSETResistance + "|" + HISETResistance + "|" + ReturnStrS[3];
