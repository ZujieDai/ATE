...
namespace SaiTer.ATE.Business
{
    ...
    /// 绝缘电阻测试类
    /// </summary>
    public class InsulationResistance : BusinessBase
    {
        ...
        public InsulationResistance(int trialType)
        {
            TrialType = trialType;
        }
        /// <summary>
        ...
        public override void ProcessData()
        {
            ...
            try
            {
                ...
                {
                    string data = TrialItem.ItemName.Split('_')[0] + "|" + TrialItem.ItemName.Split('_')[1] + "|" + LOSETResistance + "|" + HISETResistance + "|null";
                    StResultData Result = ResultData.Dequeue();
