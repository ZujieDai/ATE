...
namespace SaiTer.ATE.Business
{
    ...
    /// 通讯中断试验
    /// </summary>
    public class CCS2_PT_DC_CommunicationOutage : BusinessBase
    {
        public CCS2_PT_DC_CommunicationOutage(int type)
        {
            TrialType = type;
        }
        ...
        private void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    SendNoticeToUIAndTxtFile("正在发送通讯中断命令中...");
                    ...
                    ProcessDataTmp(dic, "通讯中断故障", "充电电压(V)", "0", "20");
                }
            }
