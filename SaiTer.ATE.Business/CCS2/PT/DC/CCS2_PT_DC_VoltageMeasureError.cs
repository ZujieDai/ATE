...
namespace SaiTer.ATE.Business
{
    ...
    /// 输出电压测量误差
    /// </summary>
    public class CCS2_PT_DC_VoltageMeasureError : BusinessBase
    {
        public CCS2_PT_DC_VoltageMeasureError(int type)
        {
            TrialType = type;
        }
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (IsRLoad(DemandVoltage3, DemandCurrent))
                    {
                        ...
                        var dicV = GetPowerAnalyzerVoltage(testWorkParam.lstIDs, CheckVoltage5, CheckVoltage6);
                    ...
                    var dicV2 = GetPowerAnalyzerVoltage(testWorkParam.lstIDs, CheckVoltage5, CheckVoltage6);
                    ...
                    if (IsRLoad(DemandVoltage2, DemandCurrent))
                    {
                        ...
                        var dicV = GetPowerAnalyzerVoltage(testWorkParam.lstIDs, CheckVoltage3, CheckVoltage4);
                    ...
                    dicV2 = GetPowerAnalyzerVoltage(testWorkParam.lstIDs, CheckVoltage3, CheckVoltage4);
                    ...
                    if (IsRLoad(DemandVoltage1, DemandCurrent))
                    {
                        ...
                        var dicV = GetPowerAnalyzerVoltage(testWorkParam.lstIDs, CheckVoltage1, CheckVoltage2);
                    ...
                    dicV2 = GetPowerAnalyzerVoltage(testWorkParam.lstIDs, CheckVoltage1, CheckVoltage2);
