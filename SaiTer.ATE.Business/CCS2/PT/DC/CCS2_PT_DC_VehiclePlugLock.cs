...
{
    /// <summary>
    /// 车辆插头锁止功能测试(IEC61851-2014 6.4.3.104)
    /// </summary>
    public class CCS2_PT_DC_VehiclePlugLock : BusinessBase
    {
        string ItemFlow = "";
        double BMSDemandVolt = 0;
        double ResiLoadCurrent = 0;
        float trlTimeOut_S = 100;//超时时间
        public CCS2_PT_DC_VehiclePlugLock(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                ProcessDataTmp(d1, ItemFlow, "充电电压(V)", "-", "-");
