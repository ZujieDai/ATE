...
namespace SaiTer.ATE.Business
{
    ...
    /// 输出电压超过车辆允许值
    /// </summary>
    public class CCS2_PT_DC_OutputOvervoltage : BusinessBase
    {
        public CCS2_PT_DC_OutputOvervoltage(int type)
        {
            TrialType = type;
        }
        ...
        private void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    if (ControlEquipMent.FeedbackLoad != null)//如果有回馈载用回馈载模拟
                    {
                        SetLoadPara(testWorkParam.lstIDs, ExceedBattery, 20, ExceedBattery, 20);
