...
namespace SaiTer.ATE.Business
{
    ...
    /// 一般要求
    /// </summary>
    public class CCS2_PT_DC_GeneralRequirementsTest : BusinessBase
    {
        string itemFlow = "";
        public CCS2_PT_DC_GeneralRequirementsTest(int type) { TrialType = type; }
        ...
        public override void ProcessData()
        {
            ...
            foreach (var item in testWorkParam.lstIDs)
            {
                ...
                double volate = 0;
                if (LstChargerInfo[0].ChargerType == EmChargerType.Charger_USA_DC ||
                    LstChargerInfo[0].ChargerType == EmChargerType.Charger_EUR_DC)
                {
                    volate = AllEquipStateData.DicBMS_EU_DC_StateData[LstTrialData[k].ChargerId].ChargingVoltage;
                }
                else
                {
                ...
                //界面展示的数据项格式
                //状态|测试结果     
                LstTrialData[k].ExtentData = "一般要求|-|-|-|-";
