...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标研测交流：通信功能测试
    /// </summary>
    public class CCS2_RT_AC_CommunicationsTest : BusinessBase
    {
        public CCS2_RT_AC_CommunicationsTest(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    string info = "[Communication Test] for manual inspection.\r\nPlease confirm whether it is pass (check if it is pass)";
