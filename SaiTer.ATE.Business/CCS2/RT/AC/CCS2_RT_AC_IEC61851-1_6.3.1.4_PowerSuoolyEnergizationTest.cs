...
{
    /// <summary>
    /// 欧标研测交流：给电动汽车充电（测CP断线后的CP电压）
    /// </summary>
    public class CCS2_RT_AC_PowerSuoolyEnergizationTest : BusinessBase
    {
...
        Dictionary<int, double[]> OscTime_Tmp = new Dictionary<int, double[]>();//示波器光标卡点时间
        ...
        string itemFlow = "";
        public CCS2_RT_AC_PowerSuoolyEnergizationTest(int type) { TrialType = type; }
