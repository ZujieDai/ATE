...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标研测交流：充电模式
    /// </summary>
    public class CCS2_RT_AC_ChargingModesTest : BusinessBase
    {
        string itemFlow = "";
        public CCS2_RT_AC_ChargingModesTest(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    itemFlow = "充电模式";
                    string info = $"电动汽车充电设备应根据 6.2 分类：模式1，模式2，模式3和模式4（注意具有多个输出的 EV 充电设备可分类为支持多种模式。）\r\n请确认是否合格(勾选上为合格)";
