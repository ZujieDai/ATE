...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标研测交流：防触电保护
    /// </summary>
    public class CCS2_RT_AC_ElectricShockProtectionTest : BusinessBase
    {
        string itemFlow = "";
        public CCS2_RT_AC_ElectricShockProtectionTest(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    itemFlow = "防触电保护";
                    string info = $"设备应根据防触电保护进行分类：I，II 和 III 类（说明可在 IEC 61140：2016、7.3、7.4 和 7.5 中找到。）\r\n请确认是否合格(勾选上为合格)";
