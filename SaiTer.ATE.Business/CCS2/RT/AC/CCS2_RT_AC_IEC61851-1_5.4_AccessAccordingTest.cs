...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标研测交流：通道分类
    /// </summary>
    public class CCS2_RT_AC_AccessAccordingTest : BusinessBase
    {
        string itemFlow = "";
        public CCS2_RT_AC_AccessAccordingTest(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    itemFlow = "预定用途进行分类";
                    string info = $"电动汽车充电设备应根据其预定用途进行分类：通路受限或通道无限制地点的设备。\r\n请确认是否合格(勾选上为合格)";
