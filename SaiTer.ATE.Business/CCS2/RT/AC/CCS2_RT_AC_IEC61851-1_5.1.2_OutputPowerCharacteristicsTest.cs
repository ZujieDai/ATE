...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标研测交流：电源输出的特性
    /// </summary>
    public class CCS2_RT_AC_OutputPowerCharacteristicsTest : BusinessBase
    {
        string itemFlow = "";
        public CCS2_RT_AC_OutputPowerCharacteristicsTest(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    itemFlow = "充电设备应根据电流类型进行分类";
                    string info = $"电动汽车充电设备应根据电动汽车充电设备提供的电流类型进行分类：交流和/或直流电动汽车充电设备。\r\n请确认是否合格(勾选上为合格)";
