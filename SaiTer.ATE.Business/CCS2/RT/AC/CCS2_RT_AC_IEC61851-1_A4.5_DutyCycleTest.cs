...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标交流研测：占空比测试
    /// </summary>
    public class CCS2_RT_AC_DutyCycleTest : BusinessBase
    {
        double PwmMax = 96;
        double PwmMin = 10;
        ...
        public CCS2_RT_AC_DutyCycleTest(int trialType) { TrialType = trialType; }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                if (testWorkParam.lstIDs.Count > 0)
                {
                    ...
                    ProcessDataTmp(DicPwm, "最大电流测试", "CP占空比", "10", "90", dicPath);
