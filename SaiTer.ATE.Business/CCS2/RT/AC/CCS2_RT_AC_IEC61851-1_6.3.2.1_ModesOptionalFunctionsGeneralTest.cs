...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标研测交流：模式可选功能概述
    /// </summary>
    public class CCS2_RT_AC_ModesOptionalFunctionsGeneralTest : BusinessBase
    {
        string itemFlow = "";
        public CCS2_RT_AC_ModesOptionalFunctionsGeneralTest(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    itemFlow = "模式可选功能概述";
                    string info = $"已实现的可选功能应在手册中指出，并应满足6.3.2（能源供应期间的通风）的要求。\r\n请确认是否合格(勾选上为合格)";
