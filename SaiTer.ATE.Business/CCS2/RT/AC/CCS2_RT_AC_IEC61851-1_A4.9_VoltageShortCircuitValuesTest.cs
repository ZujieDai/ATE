...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标研测交流：试验电压的短路值
    /// </summary>
    public class CCS2_RT_AC_VoltageShortCircuitValuesTest : BusinessBase
    {
...
        Dictionary<int, double[]> OscTime_Tmp = new Dictionary<int, double[]>();//示波器光标卡点时间
        ...
        public CCS2_RT_AC_VoltageShortCircuitValuesTest(int trialType) { TrialType = trialType; }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                if (testWorkParam.lstIDs.Count > 0)
                {
                    ...
                    SendNoticeToUIAndTxtFile("模拟电压短路");
                    //模拟CP接地
                    var Ks = GetKStatus16_Charging();
                    Ks[4] = true;
                    ...
                    ProcessDataTmp(dd, "电压短路", "保护时间(ms)", "0", "100", dImgs);
