...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标研测交流：正常环境条件
    /// </summary>
    public class CCS2_RT_AC_NormalEnvironmentalConditionsTest : BusinessBase
    {
        string itemFlow = "";
        public CCS2_RT_AC_NormalEnvironmentalConditionsTest(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    itemFlow = "根据环境条件和用途分类";
                    string info = $"电动汽车充电设备应根据环境条件和用途分类：室内使用或户外使用。\r\n请确认是否合格(勾选上为合格)";
