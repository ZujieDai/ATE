...
namespace SaiTer.ATE.Business
{
    ...
    /// </summary>
    public class CCS2_RT_DC_PowerSuoolyEnergization : BusinessBase
    {
...
        Dictionary<int, double[]> OscTime_Tmp = new Dictionary<int, double[]>();//示波器光标卡点时间
        ...
        string itemFlow = "";
        public CCS2_RT_DC_PowerSuoolyEnergization(int type) { TrialType = type; }
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (testWorkParam.lstIDs.Count > 0)
                    {
                        ...
                        CountDownTimeInfo("请确认充电机是否不能(手动)充电", 999, 0);
                        ...
                        ProcessDataTmp(Data_Tmp, "断开设备连接", "输出电压(V)", "0", "20");
                        ...
                        ProcessDataTmp(Data_Tmp, "断开设备连接", "CP电压(V)", "11.4", "12.6", dImgs);
                        #endregion
                        ...
                        ProcessDataTmp(Data_Tmp, "正常设备连接", "输出电压(V)", "50", "-");

                        Data_Tmp = ControlEquipMent.Oscilloscope.Oscilloscope_ReadMeasure(testWorkParam.lstIDs, "TOP", 3);
                        ProcessDataTmp(Data_Tmp, "正常设备连接", "CP电压(V)", "5.47", "6.53", dImgs);
                        #endregion
                    }
                }
            }
