...
namespace SaiTer.ATE.Business
{
    ...
    /// 欧标研测直流：直流桩启动紧急停止
    /// </summary>
    public class CCS2_RT_DC_DCSupplyInitiatedEmergencyShutdown : BusinessBase
    {
        public CCS2_RT_DC_DCSupplyInitiatedEmergencyShutdown(int type)
        {
            TrialType = type;
        }
        ...
        private void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    ProcessDataTmp(dd, "急停", "急停下降时间(ms)", "0", "1000", dImgs);
                    ...
                    ProcessDataTmp(dd, "启动", "电流下降速率(A/s)", "200", "-");
