...
namespace SaiTer.ATE.Business
{
    ...
    /// 交流三相相序保护测试
    /// </summary>
    public class CZ_NTGX_CN_ACPhaseSequenceProtection : BusinessBase
    {
        public CZ_NTGX_CN_ACPhaseSequenceProtection(int type)
        {
            TrialType = type;
        }
        ...
        private void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    //模拟电网相序
                    SendNoticeToUIAndTxtFile("模拟电网相序异常...");
                    ControlEquipMent.ACSource.ACSource_SetAngle3(testWorkParam.lstIDs, 0, 120, 240);
                    ControlEquipMent.ACSource.ACSource_ON(testWorkParam.lstIDs);
                    Thread.Sleep(3000);//这里再发一次
                    ControlEquipMent.ACSource.ACSource_SetAngle3(testWorkParam.lstIDs, 0, 120, 240);
                    ...
                    ControlEquipMent.ACSource.ACSource_SetAngle3(testWorkParam.lstIDs, 0, 240, 120);//恢复相序
                    Thread.Sleep(5000);
                    ...
                    ProcessDataTmp(dic, "相序异常后", "放电电压(V)", (0).ToString(), (20).ToString());//需要停止充电
        ...
        public override void InitializeParams()
        {
            ...
            ////放电电压(V)=220|放电电流(A)=10|频率上限(Hz)=55|频率下限(Hz)=45
