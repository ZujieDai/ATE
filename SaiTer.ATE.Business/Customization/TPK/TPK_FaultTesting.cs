...
namespace SaiTer.ATE.Business
{
    ...
    public class TPK_FaultTesting : BusinessBase
    {

        public TPK_FaultTesting(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                ProcessDataTmp(dicVolt, "故障测试", "充电电压(V)", (ChargingVolt - 50).ToString("F2"), (ChargingVolt + 50).ToString("F2"));

                CountDownTimeInfo("正常充电中，请按电子锁模拟故障 ", 99, 2);  //提示
                Thread.Sleep(1000);
                ...
                ProcessDataTmp(dicVolt, "按电子锁后", "充电电压(V)", (ChargingVolt - 50).ToString("F2"), (ChargingVolt + 50).ToString("F2"));
                Thread.Sleep(2000);
                ...
                CountDownTimeInfo("正常充电中，请模拟故障，拔掉充电桩电表通讯线", 99, 2);  //提示
                Thread.Sleep(4000);
                ...
                ProcessDataTmp(dicVolt, "拔掉充电桩电表通讯线", "充电电压(V)", "0", "60");
                ...
                CountDownTimeInfo("正常充电中，请模拟故障，拔掉充电桩电源模块通讯线 ", 99, 2);  //提示
                Thread.Sleep(6000);
                ...
                ProcessDataTmp(dicVolt, "拔掉充电桩电表通讯线或电源模块通讯线", "充电电压(V)", "0", "60");


                ControlEquipMent.BMS.BMS_OFF(testWorkParam.lstIDs);

                CountDownTimeInfo("请恢复故障！", 10, 2);
            }
        }
