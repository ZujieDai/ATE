...
{
    public class TPK_NFC_GB_DC : BusinessBase
    {
        public TPK_NFC_GB_DC(int trialType)
        {
            TrialType = trialType;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    list.Add(TrialItem.ItemName + "-请刷卡启动充电");
                    list.Add(TrialItem.ItemName + "-请刷卡停止充电");
