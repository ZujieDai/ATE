...
namespace SaiTer.ATE.Business
{
        ...
        public class TPK_Fan : BusinessBase
        {

            public TPK_Fan(int type)
            {
                TrialType = type;
            }
            ...
            public void StartItemFlow()
            {
                ...
                while (true)
                {
                    ...
                    ProcessDataTmp(dicVolt, "充电中风扇测试", "充电电压(V)", (ChargingVolt - 50).ToString("F2"), (ChargingVolt + 50).ToString("F2"));


                CountDownTimeInfo("充电中，请检查（风扇）是否正常开启。\r\n请确认是否合格 注：勾选上为合格", 60, 2);
                ProcessDataResults(testWorkParam.lstIDs, "-", "-", DicManualVerifyResult, "充电中风扇检查");
                Thread.Sleep(500);
