...
namespace SaiTer.ATE.Business
{
    ...
    public class TPK_EmergencyStop : BusinessBase
    {

        public TPK_EmergencyStop(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                ProcessDataTmp(dicVolt, "急停测试", "充电电压(V)", (ChargingVolt - 50).ToString("F2"), (ChargingVolt + 50).ToString("F2"));

                CountDownTimeInfo("正常充电中，请按急停 ", 99, 2);  //提示
                Thread.Sleep(1000);
                ...
                ProcessDataTmp(dicVolt, "按急停后", "充电电压(V)", "0", "20");
                Thread.Sleep(6000);
                ...
                CountDownTimeInfo("急停按钮已按下，请恢复急停按钮！", 10, 2);
