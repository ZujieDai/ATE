...
namespace SaiTer.ATE.Business
{
    ...
    /// JS定制：接地试验（人工）
    /// </summary>
    public class CZ_JS_EarthingConductor_Manual : BusinessBase
    {
        ...
        public CZ_JS_EarthingConductor_Manual(int trialType)
        {
            TrialType = trialType;
        }
        /// <summary>
        ...
        {
            //电流值(A)=25.00|HISET电阻值(mΩ)=100.00|测试时间(S)=60.00
