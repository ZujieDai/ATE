...
namespace SaiTer.ATE.Business
{
    ...
    /// 输出电流设定误差
    /// </summary>
    public class OutputCurrentSetError : BusinessBase
    {
        int trlTimeOut_S = 30;
        ...
        public OutputCurrentSetError(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                if (!CheckSwipingCard(testWorkParam.lstIDs, BMSDemandVolt, OutputCurrent1, BMSDemandVolt, false))
                {
                    return;
                }
                SetConditionValues();
                ...
                WaitDCCurrent(testWorkParam.lstIDs, OutputCurrent1);
                Thread.Sleep(1000 * 3);
                ...
                SetLoadDCON(testWorkParam.lstIDs);
                WaitDCCurrent(testWorkParam.lstIDs, OutputCurrent2);
                Thread.Sleep(1000 * 3);
