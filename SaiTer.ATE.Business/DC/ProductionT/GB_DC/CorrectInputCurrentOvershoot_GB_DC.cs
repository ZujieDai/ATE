...
namespace SaiTer.ATE.Business
{
    ...
    /// 国标直流  输入电流过冲修正
    /// </summary>
    public class CorrectInputCurrentOvershoot_GB_DC : BusinessBase
    {
        ...
        Dictionary<int, string> dImgs2 = new Dictionary<int, string>();//图片存储
        int trlTimeOut_S = 30;
        ...
        public CorrectInputCurrentOvershoot_GB_DC(int type)
        {
            TrialType = type;
        }
        ...
        public override void InitializeParams()
        {
            ...
            dImgs2 = new Dictionary<int, string>();//图片存储
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    //设置时基ms
                    ControlEquipMent.Oscilloscope.Oscilloscope_TimeBase(testWorkParam.lstIDs, true, "1000", "0");
                    //添加测量值
                    ...
                    //dImgs = ControlEquipMent.Oscilloscope.OscilloscopeSaveScreen(testWorkParam.lstIDs);
                    ProcessDataTmp(dicInACImax2, BMSDemandVolt + "V," + ResiLoadCurrent + "A", "稳定输入电流最大值", "-", "-", dImgs2);
