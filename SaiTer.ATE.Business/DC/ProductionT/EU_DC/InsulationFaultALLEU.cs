...
namespace SaiTer.ATE.Business
{
    ...
    public class InsulationFaultALLEU : BusinessBase
    {
        public InsulationFaultALLEU(int type)
        {
            TrialType = type;
        }
        ...
        private void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    ProcessDataTmp(dic, "DC+DC-对地300kΩ", "充电电压(V)", MinAllowChargeVoltage.ToString(),MaxAllowChargeVoltage.ToString());
                    ...
                    ProcessDataTmp(dic, "DC-对地300kΩ", "充电电压(V)", MinAllowChargeVoltage.ToString(), MaxAllowChargeVoltage.ToString());
