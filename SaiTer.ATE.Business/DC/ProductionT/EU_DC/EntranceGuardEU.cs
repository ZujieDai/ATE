...
namespace SaiTer.ATE.Business
{
    ...
    /// 门禁故障检测
    /// </summary>
    public class EntranceGuardEU : BusinessBase
    {
        public EntranceGuardEU(int type)
        {
            TrialType = type;
        }
        ...
        private void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    CountDownTimeInfo("请打开门禁！", 9999, 0);
                    ...
                    ProcessDataTmp(dic, "门禁故障", "充电电压(V)", "0", "20");
                    ...
                    CountDownTimeInfo("请关闭门禁！", 9999, 0);
