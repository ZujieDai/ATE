...
namespace SaiTer.ATE.Business
{
    ...
    /// 预充电试验欧标
    /// </summary>
    public class PrechargeEU : BusinessBase
    {
        public PrechargeEU(int type)
        {
            TrialType = type;
        }
        ...
        private void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    SetLoadPara(testWorkParam.lstIDs, BMSDemandVolt - 20, ResiLoadCurrent + 5, BMSDemandVolt-5, ResiLoadCurrent);
                   SetLoadDCON(testWorkParam.lstIDs);
                    ...
                    ProcessDataTmp(dicC, "检测充电中电流1", "充电电流(A)", ((ResiLoadCurrent + 5) *0.9).ToString(), ((ResiLoadCurrent + 5) * 1.1).ToString());
