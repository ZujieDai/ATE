...
namespace SaiTer.ATE.Business
{
    ...
    /// 研发测试:输出电流响应时间
    /// </summary>
    public class OutputCResponseTime : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public OutputCResponseTime(int type)
        {
            TrialType = type;
        }
        ...
        public override void InitEquiMent()
        {
            ...
            double Current_Y2 = (DemandCurrent - MinusCurrent1) * 0.99;
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    double DownCurrent = (DemandCurrent - MinusCurrent1) * 0.97;
                    ...
                    ControlEquipMent.Oscillograph?.Oscillograph_CursorPosition_X_Single(1, false, 0, -3, true);
                    DownCurrent = (DemandCurrent - MinusCurrent2) * 0.97;
                    SystemEvent.MessageInfo(true, "判断结果中...");
