...
namespace SaiTer.ATE.Business
{
    ...
    /// 研测：显示功能试验
    /// </summary>
    public class ShowFunctionTest : BusinessBase
    {
        public ShowFunctionTest(int type) { TrialType = type; }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    if (DicManualVerifyResult.FirstOrDefault().Value)
                        ProcessDataResult(testWorkParam.lstIDs, "是", "是否显示符合规定", true, ItemFlow);
                    else
                        ProcessDataResult(testWorkParam.lstIDs, "否", "是否显示符合规定", false, ItemFlow);
                    ...
                    CountDownTimeInfo("请恢复充电机正常", CheckTime, 0);
                }
            }
