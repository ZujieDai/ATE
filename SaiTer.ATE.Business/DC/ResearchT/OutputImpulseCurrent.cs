...
namespace SaiTer.ATE.Business
{
    ...
    ///输出冲击电流  直流研发测试
    /// </summary>
    public class OutputImpulseCurrent : BusinessBase
    {
        public OutputImpulseCurrent(int trialType) { TrialType = trialType; }
        ...
        public void StartItemFlow()
        {
            ...
            while (true)
            {
                ...
                while (timeout-- > 0)
                {
                    string state = AllEquipStateData.DicBMS_DC_StateData[testWorkParam.lstIDs[0]].ChargingState;
