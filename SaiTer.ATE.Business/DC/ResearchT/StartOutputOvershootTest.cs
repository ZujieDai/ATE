...
namespace SaiTer.ATE.Business
{
    ...
    public class StartOutputOvershootTest : BusinessBase
    {
        ...
        public StartOutputOvershootTest(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    SetLoadPara(testWorkParam.lstIDs, DemandVoltage - 120, DemandCurrent / 2, DemandVoltage - 100, 5);
                    Thread.Sleep(500);
                    ...
                    SendNoticeToUIAndTxtFile("设置录波仪参数中...");
                    OscillographStartupOutputOvershoot1(DemandVoltage);
                    Thread.Sleep(2000);
                    ...
                    if (ControlEquipMent.LoopFeedbackLoad != null)
                    {
                        ...
                        while (count1-- > 0)
                        {
                            dicTemp1 = ControlEquipMent.Oscillograph.Oscillograph_ReadTrigger();
                            if (dicTemp1[testWorkParam.lstIDs[0]] == 0)
                            {
                                if (AllEquipStateData.DicBMS_DC_StateData[testWorkParam.lstIDs.First()].ChargingCurrent < 10)
                                    OscillographInstrument_SetTrigger(DemandVoltage - 10, 4, 0, "RISE", false, 30, "Single");
                                else
                                    break;
                            }
                            else
                    ...
                    ReadTriggerTypeOscillograph(10);

                    System.Threading.Thread.Sleep(5000);
                    SendNoticeToUIAndTxtFile("停止录波仪滚动中...");
                    ControlEquipMent.Oscillograph.Oscillograph_IsRun(false);
                    System.Threading.Thread.Sleep(2000);


                    SendNoticeToUIAndTxtFile("读取录波仪电压最大值...");
                    Dictionary<int, string> VoDCImaxs = ControlEquipMent.Oscillograph.Oscillograph_ReadMeasure("MAXimum", 4, false, 0);
                    ...
                    SendNoticeToUIAndTxtFile("设置导引参数中...");
                    ControlEquipMent.BMS.SetParameter(testWorkParam.lstIDs, DemandVoltage, 5, false, 390);
                    ...
                    OscillographStartupOutputOvershoot2(DemandCurrent);
                    System.Threading.Thread.Sleep(3000);
                    ...
                    while (count-- > 0)
                    {
                        ...
                        if (dicTemp[testWorkParam.lstIDs[0]] == 0)
                        {
                            ...
                            //    Thread.Sleep(5000);
                            if (AllEquipStateData.DicBMS_DC_StateData[testWorkParam.lstIDs.First()].ChargingCurrent < 10)
                                OscillographInstrument_SetTrigger(DemandCurrent * 0.667, 1, 0, "RISE", false, 30, "Single");
                            else
                                break;
                        }
                        else
                    ...
                    Dictionary<int, string> InDCImaxs = ControlEquipMent.Oscillograph.Oscillograph_ReadMeasure("MAXimum", 1, false, 0);
                    System.Threading.Thread.Sleep(3000);
                    ...
                    foreach (var item in testWorkParam.lstIDs)
                    {
                        ...
                        double ErrorRate2 = (InDCImax - DemandCurrent) / DemandCurrent;
                    ...
                    ProcessDataTmp(dErrorRate2, "预充进入充电阶段", "稳流大于等于30A过冲测试结果(%)", "-", ErrorPercentage2.ToString(), dImgs2);
                    #endregion
                    ...
                    SendNoticeToUIAndTxtFile("设置录波仪触发自动...");
                    ...
                    OscillographStartupOutputOvershoot3(DemandCurrent2);
                    System.Threading.Thread.Sleep(3000);
                    ...
                    while (count-- > 0)
                    {
                        ...
                        if (dicTemp[testWorkParam.lstIDs[0]] == 0)
                        {
                            ...
                            //    Thread.Sleep(5000);
                            if (AllEquipStateData.DicBMS_DC_StateData[testWorkParam.lstIDs.First()].ChargingCurrent < 10)
                                OscillographInstrument_SetTrigger(DemandCurrent2 * 0.667, 1, 0, "RISE", false, 30, "Single");
                            else
                                break;
                        }
                        else
                    ...
                    SendNoticeToUIAndTxtFile("读取录波仪电流最大值...");
                    Dictionary<int, string> InDCImax2s = ControlEquipMent.Oscillograph.Oscillograph_ReadMeasure("MAXimum", 1, false, 0);
                    System.Threading.Thread.Sleep(3000);
                    ...
                    ProcessDataTmp(dErrorRate3, "预充进入充电阶段", "稳流小于30A过冲测试结果(A)", "-", ErrorValue.ToString(), dImgs3);
                    ...
                    SendNoticeToUIAndTxtFile("读取录波仪电压最大值...");
                    VoDCImaxs = ControlEquipMent.Oscillograph.Oscillograph_ReadMeasure("MAXimum", 4, false, 0);
                    System.Threading.Thread.Sleep(3000);
                    ...
                    ControlEquipMent.BMS.SetParameter(testWorkParam.lstIDs, DemandVoltage, 5, false, DemandVoltage);
                    WaitDCVoltage(testWorkParam.lstIDs, DemandVoltage);
                    System.Threading.Thread.Sleep(5000);
                    ...
                    SendNoticeToUIAndTxtFile("读取录波仪电流最大值...");
                    InDCImaxs = ControlEquipMent.Oscillograph.Oscillograph_ReadMeasure("MAXimum", 1, false, 0);
                    System.Threading.Thread.Sleep(3000);

                    dImgs2 = ControlEquipMent.Oscillograph?.OscillographSaveScreen();
                    ...
                    ProcessDataTmp(dErrorRate2, "暂停状态进入充电", "稳流大于等于30A过冲测试结果(%)", "-", ErrorPercentage2.ToString(), dImgs2);
                    #endregion
                    ...
                    SendNoticeToUIAndTxtFile("实战录波仪触发自动...");
                    ControlEquipMent.Oscillograph.Oscillograph_TriggerTypeSet("Auto");
                    ...
                    System.Threading.Thread.Sleep(2000);
                    SendNoticeToUIAndTxtFile("读取录波仪电流最大值...");
                    InDCImax2s = ControlEquipMent.Oscillograph.Oscillograph_ReadMeasure("MAXimum", 1, false, 0);
                    System.Threading.Thread.Sleep(3000);
                    dImgs3 = ControlEquipMent.Oscillograph?.OscillographSaveScreen();
                    ...
                    ProcessDataTmp(dErrorRate3, "暂停状态进入充电", "稳流小于30A过冲测试结果(A)", "-", ErrorValue.ToString(), dImgs3);
                    #endregion
        ...
        private void InitOscillograph()
        {
            try
            {
                ...
                ControlEquipMent.Oscillograph?.Oscillograph_AddMeasure("MAXimum", 4, false, 0);
            }
            catch (Exception ex)
            {
        ...
        /// 启动输出过冲
        /// </summary>
        public void OscillographStartupOutputOvershoot1(double Voltage)
        {
            try
            {
                OscillographInstrument_SetTrigger(Voltage - 10, 4, 0, "RISE", false, 30, "Single");
                System.Threading.Thread.Sleep(100);
                ControlEquipMent.Oscillograph?.Oscillograph_TimeBase("0.5");
                System.Threading.Thread.Sleep(100);
                ControlEquipMent.Oscillograph?.Oscillograph_IsRun(true);
                System.Threading.Thread.Sleep(100);
                ControlEquipMent.Oscillograph?.Oscillograph_CursorsSet("");//设置测量项为XY
                System.Threading.Thread.Sleep(100);
            }
            catch (Exception ex)
            {
        ...
        /// 启动输出过冲2
        /// </summary>
        public void OscillographStartupOutputOvershoot2(double DemandCurrent)
        {
            try
            {
                SendNoticeToUIAndTxtFile($"设置录波仪触发值{DemandCurrent * 0.667}...");
                OscillographInstrument_SetTrigger(DemandCurrent * 0.667, 1, 0, "RISE", false, 30, "Single");
                System.Threading.Thread.Sleep(100);
                if(Customer != null && Customer.ToString().ToUpper().Equals("KS"))
        ...
        /// 启动输出过冲3
        /// </summary>
        public void OscillographStartupOutputOvershoot3(double DemandCurrent)
        {
            try
            {
                OscillographInstrument_SetTrigger(DemandCurrent * 0.667, 1, 0, "RISE", false, 30, "Single");
