...
namespace SaiTer.ATE.Business
{
    ...
    /// 研发测试:蓄电池电压超过充电机范围试验
    /// </summary>
    public class BatteryVoltageExceed : BusinessBase
    {
        ...
        public BatteryVoltageExceed(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    ControlEquipMent.BMS.BMSSetBatteryVoltage(testWorkParam.lstIDs, StorageBatteryVoltage_New);
                    ...
                    SendNoticeToUIAndTxtFile("开启导引中");
                    ControlEquipMent.BMS.BMSSetBatteryVoltage(testWorkParam.lstIDs, StorageBatteryVoltage_New2);
                    ControlEquipMent.BMS.SetParameter(testWorkParam.lstIDs, DemandVoltage, 200, true, 390);
