...
namespace SaiTer.ATE.Business
{
    ...
    /// 保护接地连续性测试 研测（PE断线测试）
    /// </summary>
    public class PEDisConnectionTest : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public PEDisConnectionTest(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    //CountDownTimeInfo("请确认电子锁在直流60V以下后正常解锁!", 999, 2);

                    //ProcessDataWarn("人工确认电子锁在直流60V以下后正常解锁");
