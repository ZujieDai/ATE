...
namespace SaiTer.ATE.Business
{
    ...
    /// 研发测试:连接确认测试
    /// </summary>
    public class ConnectionCTest : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        /// 录波仪器时间轴第一点(s)
        /// </summary>
        Double TimeBase1 = 0.02;
        /// <summary>
        /// 录波仪器时间轴第二点(s)
        /// </summary>
        Double TimeBase2 = 0.2;
        public ConnectionCTest(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    Thread.Sleep(1000);
                    string CC1Value1 = OscillographInstrumentReadValue(3, false, 0);
                    //string CC2Value1 = OscillographInstrumentReadValue(5, false, 0);
                    ...
                    ProcessDataTmp(dCC1Value1, "空闲未插枪，断线模拟", "CC1(V)", "5.2", "6.8", dImgs);
                    ControlEquipMent.Oscillograph?.Oscillograph_IsRun(true);
                    ...
                    while (timeOut < 100)
                    {
                        CC1 = System.Math.Abs(Convert.ToDouble(OscillographInstrumentReadValue(3, false, 0)));
                    ...
                    CC1Value1 = OscillographInstrumentReadValue(3, false, 0);
                    //CC2Value1 = OscillographInstrumentReadValue(5, false, 0);
                    ...
                    ProcessDataTmp(dCC1Value2, "断线模拟并按下枪锁", "CC1(V)", "11.2", "12.8", dImgs);
                    ControlEquipMent.Oscillograph?.Oscillograph_IsRun(true);
                    ...
                    dImgs = ControlEquipMent.Oscillograph.OscillographSaveScreen();
                    ProcessDataTmp(dCC1Value3, "无断线按下枪锁", "CC1(V)", "5.2", "6.8", dImgs);
                    ControlEquipMent.Oscillograph?.Oscillograph_IsRun(true);
                    ...
                    ProcessDataTmp(dCC1Value4, "松开枪锁插枪", "CC1(V)", "3.65", "4.37", dImgs);
                    ControlEquipMent.Oscillograph?.Oscillograph_IsRun(true);
