...
namespace SaiTer.ATE.Business
{
    ...
    /// 研发测试;输出电流停止速率
    /// </summary>
    public class OutputCStopRate_CJB : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public OutputCStopRate_CJB(int type)
        {
            TrialType = type;
        }
        ...
        private void TrialMethon(double DemandVoltage, string UText)
        {
            ...
            //200V电压段的电流上升慢，需要增加时间和精度
            if (DemandVoltage == MinAllowChargeVoltage)
                WaitDCCurrentWithTime(testWorkParam.lstIDs, DemandCurrent, 50, 0.95);
            else
