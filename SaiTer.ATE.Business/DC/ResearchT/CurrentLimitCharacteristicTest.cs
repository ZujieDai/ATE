...
namespace SaiTer.ATE.Business
{
    ...
    /// 研发测试：限流特性试验
    /// </summary>
    public class CurrentLimitCharacteristicTest : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public CurrentLimitCharacteristicTest(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    { DemandVoltage, DemandVoltage, DemandVoltage, DemandVoltage - 80, DemandVoltage - 130, DemandVoltage - 270, DemandVoltage - 170, DemandVoltage - 60, DemandVoltage, DemandVoltage, DemandVoltage};
                    ...
                    { DemandCurrent - 20, DemandCurrent - 16, DemandCurrent - 10, DemandCurrent + 10, DemandCurrent + 10, DemandCurrent + 10, DemandCurrent + 10, DemandCurrent + 10, DemandCurrent - 5, DemandCurrent - 12, DemandCurrent - 15 };
