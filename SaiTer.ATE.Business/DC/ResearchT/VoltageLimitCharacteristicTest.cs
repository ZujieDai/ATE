...
namespace SaiTer.ATE.Business
{
    ...
    /// 研发测试:限压特性试验
    /// </summary>
    public class VoltageLimitCharacteristicTest : BusinessBase
    {
        int trlTimeOut_S = 30;
        /// <summary>
        /// 需求电压
        ...
        public VoltageLimitCharacteristicTest(int type)
        {
            TrialType = type;
        }
        ...
        public void StartItemFlow()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    { DemandVoltage - 220, DemandVoltage - 140, DemandVoltage - 80, DemandVoltage, DemandVoltage, DemandVoltage, DemandVoltage, DemandVoltage, DemandVoltage - 110, DemandVoltage - 190, DemandVoltage - 260 };
                    List<double> Currents = new List<double>()
                    { DemandCurrent + 20, DemandCurrent + 20, DemandCurrent + 20, DemandCurrent - 5, DemandCurrent - 15, DemandCurrent - 40, DemandCurrent - 30, DemandCurrent - 10, DemandCurrent + 20, DemandCurrent + 20, DemandCurrent + 20 };
