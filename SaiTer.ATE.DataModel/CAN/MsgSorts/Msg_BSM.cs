...
namespace SaiTer.ATE.DataModel.CAN.MsgSorts
{
    public class Msg_BSM : MsgCommon
    {
        ...
        private string DecodeBatV(string str)
        {
            ...
            vSPN3090 = result;
            string text = Function.MatchState(result, SPN.StateName.SPN3090);
            return text;
        }
        private string DecodeSoc(string str)
        {
            ...
            vSPN3091 = result;
            string text = Function.MatchState(result, SPN.StateName.SPN3091);
            return text;
        }
        private string DecodeBatChargeI(string str)
        {
            ...
            vSPN3092 = result;
            string text = Function.MatchState(result, SPN.StateName.SPN3092);
            return text;
        }
        private string DecodeBatTooHigh(string str)
        {
            ...
            vSPN3093 = result;
            string text = Function.MatchState(result, SPN.StateName.SPN3093);
            return text;
        }
        private string DecodeBatInsulate(string str)
        {
            ...
            string result = BaseConvert.GetBitsFromHex(val, 0, 2);
            vSPN3094 = result;
            string text = Function.MatchState(result, SPN.StateName.SPN3094);
            return text;
        }
        private string DecodeBatConn(string str)
        {
            ...
            string result = BaseConvert.GetBitsFromHex(val, 2, 2);
            vSPN3095 = result;
            string text = Function.MatchState(result, SPN.StateName.SPN3095);
            return text;
        }
        private string DecodeChargePermit(string str)
        {
            ...
            string result = BaseConvert.GetBitsFromHex(val, 4, 2);
            vSPN3096 = result;
            string text = Function.MatchState(result, SPN.StateName.SPN3096);
            return text;
        }
    }
}
