...
namespace SaiTer.ATE.DataModel.CAN.MsgSorts
{
    public class Msg_CEM : MsgCommon
    {
        ...
        private string TestBSMMsg = "接收动力蓄电池状态信息报文";
        ...
        public override CanMsgRich DecodeMsgData(string symbol, List<byte> content, ESGBDC_Ver eSGBDC_Ver)
        {
            ...
            try
            {
                ...
                string state = Function.MatchState(result, SPN.StateName.SPN3921);
                ...
                state = Function.MatchState(result, SPN.StateName.SPN3922);
                ...
                state = Function.MatchState(result, SPN.StateName.SPN3923);
                ...
                state = Function.MatchState(result, SPN.StateName.SPN3924);
                text += Function.TextAddColonSpace(TestChargeState, state);

                result = BaseConvert.GetBitsFromHex(val, 2, 2);
                model.ConsistMsg.SPN3925 = result;
                state = Function.MatchState(result, SPN.StateName.SPN3925);
                ...
                state = Function.MatchState(result, SPN.StateName.SPN3926);
                ...
                state = Function.MatchState(result, SPN.StateName.SPN3927);
                ...
                switch (eSGBDC_Ver)
                {
                    ...
                    case ESGBDC_Ver.GBDC_2023:
                        result = BaseConvert.GetBitsFromHex(val, 2, 2);
                        model.ConsistMsg.SPN3928 = result;
                        state = Function.MatchState(result, SPN.StateName.SPN3928);
                        text += Function.TextAddColonSpace(TestBSMMsg, state);
                        break;
