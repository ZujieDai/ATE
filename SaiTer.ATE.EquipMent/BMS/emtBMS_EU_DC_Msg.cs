...
namespace SaiTer.ATE.EquipMent
{
    ...
    /// 欧标直流导引——报文
    /// </summary>
    public class emtBMS_EU_DC_Msg : EquipMentBase
    {
        /// <summary>
        /// 用于接收欧标导引的报文，只需要接收就行了
        /// </summary>
        public emtBMS_EU_DC_Msg(int type)
        {
            this.AutoReadData = true;
            this.EquipMentName = $"{LanguageManager.GetByKey("欧标直流导引BMS")} {LanguageManager.GetByKey("报文")}";
        }
