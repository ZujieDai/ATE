...
namespace SaiTer.ATE.Controls
{
    ...
    /// 录波仪控制基类
    /// </summary>
    public class OscillographBase : ControlsBase
    {
        /// <summary>
        /// 录波仪初始化
        /// </summary>
        ...
        /// <returns>返回为try catch 的错误，没有则返回为空</returns>
        public virtual void Oscillograph_Channel_Open(List<int> lstIDs, int channel, bool isOpen) { }
        ...
        /// <param name="digittypewidth">带通滤波通带宽度 ？默认200Hz</param>
        /// <returns>返回为try catch 的错误，没有则返回为空</returns>
        public virtual void Oscillograph_Channel_SetFiltering(List<int> lstIDs, int channel, string tapewidth, int filteringtype, int digitfilteringtype, int digittapetype, string digittypewidth) { }
        ...
        /// <returns></returns>
        public virtual Dictionary<int, string> Oscillograph_ReadMeasure(int MeasureNumber) { return null; }
        ...
        /// <param name="Schannel">子通道</param>
        /// <returns></returns>
        public virtual Dictionary<int, string> Oscillograph_ReadMeasure(string MeasureType, int channel, bool isCAN, int Schannel) { return null; }
        /// <summary>
        /// 录波仪时基设置
        /// </summary>
        ...
        public virtual Dictionary<int, int> Oscillograph_ReadTrigger() { return null; }
        /// <summary>
        /// 波形数据回读
        /// </summary>
        ...
        public virtual Dictionary<int, double[]> OscillographCursorData(int channel, bool isCAN, int schannel) { return null; }
        ...
        public virtual Dictionary<int, string> OscillographSaveScreen() { return null; }
        ...
        public virtual Dictionary<int, bool> Oscillograph_ReadRun() { return null; }
        ...
        public virtual Dictionary<int, double[]> Oscillograph_ReadCursors(int channel) { return null; }

        /// <summary>
        /// 通道时间横向测量光标参数读取
        /// </summary>
        /// <returns>返回double 时间差 时间单位为ms</returns>
        public virtual Dictionary<int, double> Oscillograph_ReadCurcor() { return null; }
        /// <summary>
        /// 控制录波仪是否能触屏
        /// </summary>
        ...
        /// <param name="schannel">子通道</param>
        /// <returns>返回值</returns>
        public virtual Dictionary<int, string> GetChannelValue(int channel, bool isCan, int schannel) { return null; }
        ...
        public virtual Dictionary<int, double[]> Oscillograph_Points(double[] data, double upvalue, double downvalue, int uptype, bool isAC, double errorrate) { return null; }
        ...
        public virtual Dictionary<int, double> Oscillograph_Points_Single(double[] data, double value, int uptype, bool isright, bool isAC, double errorrate) { return null; }


        public virtual Dictionary<int, double> Oscillograph_Points_Single(double[] data, double value, int uptype, bool isright, bool isAC, double errorrate, double CheckCount) { return null; }
        /// <summary>
        /// 计算卡点值单一取首个上升沿或者下降沿
        /// </summary>
        /// <param name="data">回读的录波仪的点</param>
        ...
        /// <param name="errorrate">误差</param>
        /// <returns>返回double，返回占屏幕的比例值，跟录波仪没有关系，自己根据录波仪回读的点来进行计算</returns>
        public virtual Dictionary<int, double> Oscillograph_Points_Single2(double[] data, double value, int uptype, bool isright, bool isAC, double errorrate, int? CheckCount = null) { return null; }
        ...
        public virtual Dictionary<int, double> Oscillograph_Points_Single3(double[] data, double value, bool isAC) { return null; }
        ...
        public virtual Dictionary<int, double> Oscillograph_Points_Single_Multiple(double[] OldData, double value, int uptype, bool isright, bool isAC, double errorrate, int Index, int Count, int? CheckCount = null) { return null; }
